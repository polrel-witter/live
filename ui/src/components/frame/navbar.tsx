...
const MenuItemWithLinks: React.FC<MenuProps> = ({ linkItems, disabled }) => {
  return (
...
const NavbarWithSlots: React.FC<Props> = (
  { left, right, className, ...props },
) => {
...
export { MenuItemWithLinks, NavbarWithSlots };
